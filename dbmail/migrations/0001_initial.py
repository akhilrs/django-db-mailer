# Generated by Django 5.1.4 on 2025-01-08 15:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Created')),
                ('updated', models.DateTimeField(auto_now=True, verbose_name='Updated')),
                ('credential', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='dbmail.mailfromemailcredential', verbose_name='Auth credentials')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custom_identifier', models.CharField(blank=True, max_length=60, null=True, verbose_name='Custom Identifier')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='User')),
                ('error_exception', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='dbmail.maillogexception', verbose_name='Exception')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='files', to='dbmail.mailtemplate', verbose_name='Template')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['eta', 'done'], name='signal_eta_done_idx')],
            },
        ),
        migrations.CreateModel(
            name='SignalLog',
